<footer id="footer" class="top-space">
				...
				<div class="row">
					...
					<div class="col-md-3 widget">
						...
						<div class="widget-body">
								...
								<a href="http://localhost/ins-nordkivu">localhost/ins-nordkivu</a> <br>
								<br>
					...
					<div class="col-md-6 widget">
						...
						<div class="widget-body">
							<p><a href="http://localhost/ins-nordkivu/generales/page_terms.php">Termes et conditions</a></p>
							<p><a class="footer-brand" href="http://localhost/ins-nordkivu/index.php"><img src="http://localhost/ins-nordkivu/assets/img/logo.jpg" alt="Ins"></a></p>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
							<a href="http://localhost/ins-nordkivu/index.php">Accueil</a> |
							<a href="http://localhost/ins-nordkivu/generales/mission.php"> mission</a>|
							<a href="http://localhost/ins-nordkivu/generales/publications.php">Publications</a> |
							<a href="http://localhost/ins-nordkivu/generales/contact.php">contacter</a> |
								<b><a href="http://localhost/ins-nordkivu/generales/signin.php">Connexion</a></b>
							</p>
						</div>
					</div>
  ...
  <script src="http://unpkg.com/leaflet@1.4.0/dist/leaflet.js"
   integrity="sha512-QVftwZFqvtRNi0ZyCtsznlKSWOStnDORoefr1enyq5mVL4tmKB3S/EnC3rRJcxCPavG10IcrVGSmPh6Qw5lwrg=="
   crossorigin=""></script>
   <script src="http://localhost/ins-nordkivu/assets/js/vendor.js"></script>
    <!--<script src="http://localhost/ins-nordkivu/assets/js/tile.stamen.js"></script>-->
	<!--<script src="http://www.ins-nordkivu.org/assets/js/jquery.js"></script>
